...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  let(:my_spon_post) {my_topic.sponsored_posts.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 99)}
  ...
  describe "GET edit" do
    ...
    it "assigns spon post to be updated to @sponsored_post" do
      get :edit, topic_id: my_topic.id, id: my_spon_post.id
  ...
  describe "PUT update" do
    it "updates spon post with expected attributes" do
      new_title = RandomData.random_sentence
      new_body = RandomData.random_paragraph

      put :update, topic_id: my_topic.id, id: my_spon_post.id, sponsored_post: {title: new_title, body: new_body, price: my_spon_post.price}
    ...
    it "redirects to the updated spon post" do
      new_title = RandomData.random_sentence
      new_body = RandomData.random_paragraph
